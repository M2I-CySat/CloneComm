...
class sat_rx(gr.top_block):

    def __init__(self):
        gr.top_block.__init__(self, "CloneComm Downlink", catch_exceptions=True)
        ...
        self.center_freq = center_freq = 436.375
        ...
        self.uhd_usrp_source_0.set_center_freq(436375000, 0)
        ...
        self.satellites_satellite_decoder_0 = satellites.core.gr_satellites_flowgraph(file = '/home/cysat-radio/Desktop/CloneCommGNU/CYSAT.yml', samp_rate = 1000000, grc_block = True, iq = True, options = "")
...
def main(top_block_cls=sat_rx, options=None):
    tb = top_block_cls()
